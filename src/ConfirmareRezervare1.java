...
class ConfirmareRezervare1 extends JFrame{
    ...
    ConfirmareRezervare1(String title){
        ...
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
               ...
               try{
                    BufferedReader in=new BufferedReader(new FileReader("cost1.txt"));
                    String linie ;
        ...
        public void actionPerformed(ActionEvent ev){
          ...
          if (ev.getSource()==bOk) {
           ...
           try{
                BufferedWriter out=new BufferedWriter(new FileWriter("rezervare1.txt",true));
           ...
           if(!tf_plata.getText().equals("") ) {
                   ...
                   if(suma_introdusa>= suma_afisata) {
                       ...
                       try{
                BufferedWriter out=new BufferedWriter(new FileWriter("rest1.txt",true));
                out.write(rest+"\r\n");
                out.flush();
                out.close();
                }catch(IOException e) {
                   ...
                   new Bilet1("Bilet");
                     ...
                     JOptionPane.showMessageDialog(ConfirmareRezervare1.this,
