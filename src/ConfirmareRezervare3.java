...
class ConfirmareRezervare3 extends JFrame{
    ...
    ConfirmareRezervare3(String title){
        ...
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
               ...
               try{
                    BufferedReader in=new BufferedReader(new FileReader("cost3.txt"));
                    String linie ;
        ...
        public void actionPerformed(ActionEvent ev){
          ...
          if (ev.getSource()==bOk) {
           ...
           try{
                BufferedWriter out=new BufferedWriter(new FileWriter("rezervare3.txt",true));
           ...
           if(!tf_plata.getText().equals("") ) {
                   ...
                   if(suma_introdusa>= suma_afisata) {
                       ...
                       try{
                BufferedWriter out=new BufferedWriter(new FileWriter("rest3.txt",true));
                out.write(rest+"\r\n");
                out.flush();
                out.close();
                }catch(IOException e) {
                   ...
                   new Bilet3("Bilet");
                     ...
                     JOptionPane.showMessageDialog(ConfirmareRezervare3.this,
