...
class ReprezentatieS4 extends JFrame{
    ...
    ReprezentatieS4(String title){
        ...
        public void actionPerformed(ActionEvent ev){
            if (ev.getSource()==bOk){
                  try {
                             BufferedWriter out=new BufferedWriter(new FileWriter("spec4.txt", true));
                ...
                if (!tf_text.getText().equals("")) {
                    try{
                        BufferedWriter out=new BufferedWriter(new FileWriter("rez4.txt", true));
                ...
                try{
                        BufferedWriter out=new BufferedWriter(new FileWriter("cost4.txt", true));
                        out.write(cost+"\r\n");
                                out.flush();
                                out.close();
                 ...
                 if(Integer.parseInt(tf_text.getText()) > 1){
                  ...
                  JOptionPane.ERROR_MESSAGE);
                   ...
                   dispose();
	           new ConfirmareRezervare4("Confirmare rezervare");
