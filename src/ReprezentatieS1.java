...
import java.io.*;
import java.util.*;
class ReprezentatieS1 extends JFrame{
    double pret_spec = 67.5;
    double cost;
    ...
    ReprezentatieS1(String title){
        super(title);
        AscultatorButon ab=new AscultatorButon();
        lDen=new JLabel("Denumire spectacol: ");
        lDen1=new JLabel("O scrisoare pierdută (I.L. Caragiale)");

        lOrar=new JLabel("Orar reprezentatii");
        lOrar1=new JLabel("Selectati data favorita:");
        lData=new JLabel("      Data               Ora");
        
        reprezentatie.add("06.02.2021   10:00");
        reprezentatie.add("06.02.2021   14:00");
        reprezentatie.add("07.02.2021   09:30");
        reprezentatie.add("07.02.2021   15:30");
        ...
        p1=new JPanel();
         ...
         getContentPane().add(p2, BorderLayout.CENTER);
          ...
          p3.add(loc7);
          p3.add(loc8);
          pret=new JLabel("Preț / reprezentație: ");
          pretn=new JLabel("67.5 lei ");
    ...
    class AscultatorButon implements ActionListener{
        public void actionPerformed(ActionEvent ev){
            ...
            if (ev.getSource()==bOk){
                try {
                             BufferedWriter out=new BufferedWriter(new FileWriter("spec1.txt", true));
                             out.write("O scrisoare pierdută (I.L. Caragiale)\r\n");
                                out.flush();
                                out.close();
                         }catch (IOException e){
                ...
                if (!tf_text.getText().equals("")) {
                    ...
                    try{
                        BufferedWriter out=new BufferedWriter(new FileWriter("rez1.txt", true));
                     ...
                     try{
                        BufferedWriter out=new BufferedWriter(new FileWriter("cost1.txt", true));
                        out.write(cost+"\r\n");
                                out.flush();
                                out.close();
                 ...
                 if(Integer.parseInt(tf_text.getText()) > 1){
                      JOptionPane.showMessageDialog(ReprezentatieS1.this,"Deoarece ati facut mai multe rezervari, se va genera un abonament.","Atentionare",
                  JOptionPane.ERROR_MESSAGE);
                  }
                   dispose();
	           new ConfirmareRezervare1("Confirmare rezervare");
