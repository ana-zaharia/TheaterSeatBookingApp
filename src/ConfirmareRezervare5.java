...
class ConfirmareRezervare5 extends JFrame{
    ...
    ConfirmareRezervare5(String title){
        ...
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
               ...
               try{
                    BufferedReader in=new BufferedReader(new FileReader("cost5.txt"));
                    String linie ;
        ...
        public void actionPerformed(ActionEvent ev){
          ...
          if (ev.getSource()==bOk) {
           ...
           try{
                BufferedWriter out=new BufferedWriter(new FileWriter("rezervare5.txt",true));
           ...
           if(!tf_plata.getText().equals("") ) {
                   ...
                   if(suma_introdusa>= suma_afisata) {
                       ...
                       try{
                BufferedWriter out=new BufferedWriter(new FileWriter("rest5.txt",true));
                out.write(rest+"\r\n");
                out.flush();
                out.close();
                }catch(IOException e) {
                   ...
                   new Bilet5("Bilet");
                     ...
                     JOptionPane.showMessageDialog(ConfirmareRezervare5.this,
